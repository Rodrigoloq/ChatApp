package com.rodrigoloq.chatapp.auth.loginemail
...
import com.rodrigoloq.chatapp.auth.loginemail.viewmodel.LoginEmailUIState
import com.rodrigoloq.chatapp.auth.loginemail.viewmodel.LoginEmailViewModel
...
fun LoginEmailViewContent(
    ...
    val login = {
        ...
        if (emailTextValue.trim().isEmpty() || wrongEmailFormatError) {
            ...
            loginUser(emailTextValue, passwordTextValue)
        }
    }
