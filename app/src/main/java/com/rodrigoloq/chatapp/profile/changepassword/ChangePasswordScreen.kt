package com.rodrigoloq.chatapp.profile.changepassword
...
import com.rodrigoloq.chatapp.profile.changepassword.viewmodel.ChangePasswordUIState
import com.rodrigoloq.chatapp.profile.changepassword.viewmodel.ChangePasswordViewModel
...
fun ChangePasswordViewContent(
    ...
    LaunchedEffect(state.changePasswordSuccess) {
        when (state.changePasswordSuccess) {
            true -> {
                Toast.makeText(
                    context,
...
fun ChangePasswordView(
    ...
    ChangePasswordViewContent(
        ...
        changePassword = { actualPassword, newPassword ->
            viewModel.changePassword(actualPassword, newPassword)
        }
    )
}